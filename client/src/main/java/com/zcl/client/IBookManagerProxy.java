...
public class IBookManagerProxy implements IBookManager {
    ...
    public static final int TRANSACTION_addBookInOut = IBinder.FIRST_CALL_TRANSACTION + 1;
    ...
    public List<Book> getBookList() throws RemoteException {
        ...
        try {
            ...
            remote.transact(TRANSACTION_getBookList, data, replay, 0);
    ...
    public void addBookInOut(Book book) throws RemoteException {
        ...
        try {
            ...
            remote.transact(TRANSACTION_addBookInOut, data, replay, 0);
            replay.readException();
        } finally {
            replay.recycle();
            data.recycle();
